...
#---------------------------------------------------------------------------#
store = ModbusSlaveContext(
    # di = ModbusSequentialDataBlock(0, [20]*10),
    # co = ModbusSequentialDataBlock(0, [20]*10),
    # hr = ModbusSequentialDataBlock(0, [2]*6)
    hr = ModbusSequentialDataBlock(0, [ n*2 for n in range(10)])
    # hr=),
    # ir = ModbusSequentialDataBlock(0, [20]*10)
)
# store = ModbusSlaveContext(
